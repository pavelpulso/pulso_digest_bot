...
Выбери до 5 каналов, которые наиболее релевантны этому читателю. Учитывай типичную тематику канала по названию (username часто отражает тематику). Верни JSON — массив объектов: username (строка, из списка), reason (одно короткое предложение, почему канал подходит).`;
